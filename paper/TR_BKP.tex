...
R> gp <- gp_optim(gp, X_train, y_train, trials = m_train,
+                 method = method_full(), approx = approx_ep(), 
+                 verbose = FALSE)
\end{CodeInput} 
\end{CodeChunk}  
...
R> data <- read.csv("Code/Mourning_Warbler.csv", stringsAsFactors = FALSE)
...
R> library(terra)
R> tif_files <- file.path("climate/wc2.1_10m", paste0(bio_cols, ".tif"))
