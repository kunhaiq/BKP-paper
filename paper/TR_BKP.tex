...
The empirical coverage behavior of the fitted interval procedures is examined separately in Appendix~\ref{app:coverage}.
...
Predictive performance on the spatially withheld testing set is summarized using the area under the AUC and the Brier score.
